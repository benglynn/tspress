...
interface Pipe<T> {
    ...
    <A, B>(p1: P<T, Page[], A>, p2: P<T, A, B>): Promise<B>;
    <A, B, C>(p1: P<T, Page[], A>, p2: P<T, A, B>, p3: P<T, B, C>): Promise<C>;
    <A, B, C, D>(p1: P<T, Page[], A>, p2: P<T, A, B>, p3: P<T, B, C>, p4: P<T, C, D>): Promise<D>;
  }
